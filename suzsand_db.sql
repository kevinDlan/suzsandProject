...
--
-- Hôte : localhost:3306
-- Généré le :  jeu. 30 mai 2019 à 08:31
...
(1, 'kevinkone19@gmail.com', 'new'),
(3, 'dylan7729@gmail.com', 'new');
...
INSERT INTO `commande` (`id`, `nomPrenom`, `contact`, `articleCommande`, `prixArticle`, `dateCommande`, `etatCommande`) VALUES
(1, 'KONE Kevin', '77298466', 'Sandwich à la viande', 2500, '2019-05-23 09:05:41', 'commande traité');
...
(13, 'sand3', 'sandwich a la salade', 'Le sandwich est un mets, généralement composé de deux ou plusieurs tranches de pain, avec un ou plusieurs ingrédients entre elles. Par antonomase, le terme « sandwich »', 6000, '4.jpg', '2019-05-26');
